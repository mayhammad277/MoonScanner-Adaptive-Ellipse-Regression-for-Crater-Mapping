...
if __name__ == "__main__":
    MODEL_P = "/home/bora3i/crater_challenge/swin_crater_best_v7_d5.pth"
    TEST_DIR = "/home/bora3i/crater_challenge/test/"
    PREVIEW_DIR = "./previews_clahe_v7_d5"
    ...
    pd.DataFrame(all_detections).to_csv("submission_clahe_v7_d5.csv", index=False)
