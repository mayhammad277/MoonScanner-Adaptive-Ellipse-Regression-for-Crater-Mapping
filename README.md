...
📌 OverviewLunar-GeoNet is a high-precision computer vision pipeline designed to automate the detection and measurement of lunar craters from high-resolution satellite imagery (Mahanti Dataset).
...
Heatmap-Based Center RegressionInstead of traditional anchor boxes, the model views the lunar surface as a probability field.
...
8. ├── inference.py        # Optimized prediction engine with Adaptive Scaling
